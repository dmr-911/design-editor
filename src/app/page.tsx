...
const DesignEditor = () => {
  ...
  return (
<div className="w-full max-w-5xl mx-auto p-4 sm:p-6 grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 bg-gray-50 rounded-lg shadow-sm">
  {/* Left sidebar with tools */}
  <div className="md:col-span-3 bg-white rounded-lg shadow-sm p-4 flex flex-col gap-4 w-full md:w-auto">
    ...
    <div className="flex justify-between items-center mb-3">
      ...
      {state.selectedId && (
        <div className="text-sm text-gray-500">
          Shape selected: {state.shapes.find((s) => s.id === state.selectedId)?.type}
        </div>
      )}
    </div>
      ...
      {state.shapes.length === 0 && (
        <div className="flex items-center justify-center h-full text-gray-400">
          <div className="text-center">
            <p className="mb-2">Drag shapes from the sidebar to start designing</p>
